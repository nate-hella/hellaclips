...
if ( ! is_admin() ) {
    ...
    function hc_load_styles() {  // Load CSS
        ...
        //owl
        wp_register_style( 'owl-style', get_template_directory_uri() . '/owl/owl-carousel/owl.carousel.css', array(), '3.06.01', 'all' );
        wp_enqueue_style( 'owl-style' );

        wp_register_style( 'owl-style-default', get_template_directory_uri() . '/owl/owl-carousel/owl.theme.css', array(), '3.1.1', 'all' );
...
if ( function_exists( 'add_theme_support' ) ) {
    ...
    set_post_thumbnail_size( 358, 215, array( 'center', 'center')  ); 
...
*/
 ...
 function pbd_alp_init() {
    ...
    if( !is_singular() ) {  
        // Queue JS 
        wp_register_script( 'pbd-alp-load-posts', get_template_directory_uri() . '/js/load-posts.js', array('jquery'),'1.0', true);
        wp_enqueue_script( 'pbd-alp-load-posts' );
...
// include Write to functionality 
include('php/xml_write_test_function.php');
include('php/app_options.php');

// Register Custom Status
function app_post_status() {

    $argsies = array(
        'label'                     => 'On App',
        'label_count'               => 'On App (%s)',
        'public'                    => true,
        'show_in_admin_all_list'    => true,
        'show_in_admin_status_list' => true,
        'exclude_from_search'       => false,
    );
    register_post_status( 'AppPublished', $argsies );

}
add_action( 'init', 'app_post_status', 0 );

add_theme_support( 'featured-content', array(  
    'featured_content_filter' => 'hellaclips_get_featured_content',  
)); 
